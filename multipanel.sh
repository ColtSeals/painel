...
##PANIL A INSTALAR
panel_v10 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v10/Painel.sh > /dev/null 2>&1; chmod +x Painel.sh; ./Painel.sh
}
panel_v10_2 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v10_2/install.sh > /dev/null 2>&1; chmod +x install.sh; ./install.sh
}
panel_v11 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v11/Painelv11.sh > /dev/null 2>&1; chmod +x Painelv11.sh; ./Painelv11.sh
}
panel_v11_2 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v11_2/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v12 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v12/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v15 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v15/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v15_2 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v15_2/ocspanel > /dev/null 2>&1; chmod +x ocspanel; ./ocspanel
}
panel_v20 () {
    wget https://worldofdragon.net/painel/multipanel/panel_v20/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v20_mod () {
    wget https://worldofdragon.net/painel/multipanel/panel_v20_mod/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v23 () {
    wget https://raw.githubusercontent.com/ColtSeals/painel/main/install > /dev/null 2>&1; chmod +x install; ./install
}
panel_v25 () {
...
wget https://worldofdragon.net/painel/multipanel/Panelweb.sh > /dev/null 2>&1
